...
export default function Checkout() {
    ...
    const CartItemsListing = () => {
        return globals.cartItems.map((product) => {
            return (
                <li key={product.id} className="flex gap-4 py-4 justify-between">
            ...
            <section className='mt-1'>
                ...
                <div className="mx-auto grid max-w-screen h-screen grid-cols-1 md:grid-cols-2">
                            ...
                            <form className="grid grid-cols-6 gap-4">
                                <div className="col-span-3">
                                    ...
                                    <input
                                        type="text"
                                        id="FirstName"
                                        className="mt-1 w-full rounded-md border-gray-200 shadow-sm sm:text-sm text-black"
                                    />
                                </div>
                                    ...
                                    <div className="mt-1 -space-y-px rounded-md bg-white shadow-sm">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="relative mt-1 w-full rounded-t-md border-gray-200 focus:z-10 sm:text-sm text-black"
                                            />
                                        </div>
                                        ...
                                        <div className="flex">
                                            <div className="flex-1">
                                                ...
                                                <input
                                                    ...
                                                    className="relative w-full rounded-es-md border-gray-200 focus:z-10 sm:text-sm text-black"
                                                />
                                            </div>
                                            ...
                                            <div className="-ms-px flex-1">
                                                ...
                                                <input
                                                    ...
                                                    id="CardCVC"
                                                    placeholder="CVC"
                                                    className="relative w-full rounded-ee-md border-gray-200 focus:z-10 sm:text-sm text-black"
                                                />
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <fieldset className="col-span-6">
                                    ...
                                    <div className="mt-1 -space-y-px rounded-md bg-white shadow-sm">
                                        <div>
                                            ...
                                            <select
                                                id="Country"
                                                className="relative w-full rounded-t-md border-gray-200 focus:z-10 sm:text-sm text-black"
                                            >
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="relative w-full rounded-b-md border-gray-200 focus:z-10 sm:text-sm text-black"
                                            />
                                        </div>
                                    </div>
                                </fieldset>
                    ...
                    <div className="bg-gray-50 py-12 md:py-24">
                        <div className="mx-auto max-w-lg space-y-8 px-4 lg:px-8 text-black">
